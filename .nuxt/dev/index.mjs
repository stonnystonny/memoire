...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseStatus, setResponseHeader, send, getRequestHeaders, getRequestURL, getResponseHeader, setResponseHeaders, removeResponseHeader, appendResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file://A:/programming/memoir/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://A:/programming/memoir/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://A:/programming/memoir/node_modules/devalue/index.js';
import destr from 'file://A:/programming/memoir/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://A:/programming/memoir/node_modules/ufo/dist/index.mjs';
import { hash as hash$1 } from 'file://A:/programming/memoir/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://A:/programming/memoir/node_modules/@unhead/ssr/dist/index.mjs';
import { klona } from 'file://A:/programming/memoir/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://A:/programming/memoir/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://A:/programming/memoir/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://A:/programming/memoir/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://A:/programming/memoir/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://A:/programming/memoir/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://A:/programming/memoir/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://A:/programming/memoir/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://A:/programming/memoir/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://A:/programming/memoir/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://A:/programming/memoir/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://A:/programming/memoir/node_modules/youch-core/build/index.js';
import { Youch } from 'file://A:/programming/memoir/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://A:/programming/memoir/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://A:/programming/memoir/node_modules/unctx/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://A:/programming/memoir/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://A:/programming/memoir/node_modules/unhead/dist/index.mjs';
import { unref, version } from 'file://A:/programming/memoir/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file://A:/programming/memoir/node_modules/@unhead/shared/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"A:/programming/memoir/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"A:/programming/memoir"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"A:/programming/memoir/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"A:/programming/memoir/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"A:/programming/memoir/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"A:/programming/memoir/.data/kv"}));
...
const _Nn1ZT2FrhvqlbislPhjsuPvOkJRAj1bys3tYX8pqj_k = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "A:/programming/memoir";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _jbIDFEAZYQ0ALDETuhZ0fjxPndk2KQLNrYIvxammBI0 = (nitroApp) => {
...
const plugins = [
  _Nn1ZT2FrhvqlbislPhjsuPvOkJRAj1bys3tYX8pqj_k,
_jbIDFEAZYQ0ALDETuhZ0fjxPndk2KQLNrYIvxammBI0
];

const assets = {
  "/index.mjs": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"11d20-f4ePk3Rsa6/XWn2Le56Jz/2q3eQ\"",
    "mtime": "2026-05-17T14:45:40.896Z",
    "size": 72992,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"44f03-oOejaCGQgtML9uepr5kYukERbuU\"",
    "mtime": "2026-05-17T14:45:40.901Z",
    "size": 282371,
    "path": "index.mjs.map"
  }
};
...
const _OzhQNK = eventHandler((event) => {
...
const _lazy_aUj1vr = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _OzhQNK, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_aUj1vr, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_aUj1vr, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Личный дневник с заметками, фото и календарём"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>📔</text></svg>"}],"style":[],"script":[],"noscript":[],"title":"Mémoire — личный дневник"};
...
const getClientManifest = () => import('file://A:/programming/memoir/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
